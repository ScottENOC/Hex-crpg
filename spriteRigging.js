...
(() => {
    ...
    //
    // Torso anchors are the canonical body silhouette used by fitted clothing
    // and armour. Equipment code should derive its fit from these anchors
    // rather than maintaining a separate shoulder/waist/hip body approximation.
    const HUMAN_FEMALE_REFERENCE_RIGS = {
        front: {
            ...
            anchors: {
                ...
                torsoShoulderLeft: { x:0.360, y:0.250 },
                torsoShoulderRight:{ x:0.640, y:0.250 },
                torsoWaistLeft:    { x:0.390, y:0.550 },
                torsoWaistRight:   { x:0.610, y:0.550 },
                torsoHipLeft:      { x:0.370, y:0.780 },
                torsoHipRight:     { x:0.630, y:0.780 },
        ...
        side: {
            ...
            anchors: {
                ...
                torsoShoulderLeft: { x:0.460, y:0.250 },
                torsoShoulderRight:{ x:0.560, y:0.250 },
                torsoWaistLeft:    { x:0.475, y:0.550 },
                torsoWaistRight:   { x:0.545, y:0.550 },
                torsoHipLeft:      { x:0.465, y:0.780 },
                torsoHipRight:     { x:0.555, y:0.780 },
