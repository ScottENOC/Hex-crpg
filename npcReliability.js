// npcReliability.js
// Generated-NPC hardening: stable visuals, door clearance, real baldness,
// and lightweight dialogue for civilians without authored conversations.
(() => {
  'use strict';
  ...
  function installRenderStyling(){const original=window.renderEntities;if(typeof original!=='function')return false;if(original.__npcReliabilityAppearance){renderWrapped=true;return true;}const wrapped=function(...args){styleGeneratedResidents();return original.apply(this,args);};wrapped.__npcReliabilityAppearance=true;wrapped.__original=original;window.renderEntities=wrapped;renderWrapped=true;return true;}
