...
test.describe('village map and vision', () => {
    ...
    test('village buildings are carved and enterable (wood floor interiors)', async ({ page }) => {
        ...
        expect(check.interiorRegionCount).toBe(11); // tavern, store, chapel, house, general store, Old Mac's farmhouse, abandoned house, Millbrook, Ironvein hall/bunkhouse/mine
    });
