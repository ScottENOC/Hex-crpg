...
test.describe('village map and vision', () => {
    ...
    test('village buildings are carved and enterable (wood floor interiors)', async ({ page }) => {
        ...
        expect(check.interiorRegionCount).toBe(72); // tavern, store, chapel, house, general store, Mira's house, Oskar's house, Old Mac's farmhouse, abandoned house, Millbrook, Emberlode hall/bunkhouse/mine, Reddale guardhouse/Reeve's house/inn/guildhouse/manor/smithy, Silverhart great hall/barracks/council chamber/wizard's tower/queen's chambers, Diplomatic Quarter elven/dwarven/Aldenreach/Corvane embassies/Ironbond office/cathedral, Silverhart Merchant Quarter (stable/clothier/magic shop/general goods) + Noble Quarter (Corstane's manor/neighbor's house/builder's house, now a hexagon), a small cluster of 3 plain cottages north of the manor district, the east quarter (4 more houses), Middle Ring (6 houses), the Warrens (3 shacks + thieves' guild + its hidden vault behind a secret door), Northwatch Fort/keep, Ridgehold Fort/keep, the necromancer's crypt (entrance/ossuary/ritual), the lich barrow (antechamber/sanctum), the Chapterhouse of the Silver Flame, Kragmoor's Gate Hall only (the rest are real underground floors, window.multiStoryBuildings, not ground-floor interiorRegions), Sil'thandriel's arrival clearing only (the Court/Archive/Sickbed are real canopy floors now, same system), Hollowmere's Thieves' Guild den, and Silverhart's Commons (tavern + 3 scattered outlying houses)
    });
