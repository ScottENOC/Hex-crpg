...
test.describe('village map and vision', () => {
    ...
    test('village buildings are carved and enterable (wood floor interiors)', async ({ page }) => {
        ...
        expect(check.interiorRegionCount).toBe(29); // tavern, store, chapel, house, general store, Mira's house, Oskar's house, Old Mac's farmhouse, abandoned house, Millbrook, Emberlode hall/bunkhouse/mine, Reddale guardhouse/Reeve's house/inn/guildhouse/manor, Silverhart great hall/barracks/council chamber/wizard's tower/queen's chambers, Diplomatic Quarter elven/dwarven/Aldenreach/Corvane embassies/Ironbond office/cathedral
    });
