...
test.describe('village map and vision', () => {
    ...
    test('village buildings are carved and enterable (wood floor interiors)', async ({ page }) => {
        ...
        // 72 is the established pre-social-fabric world. New legitimate
        // dwellings/districts should increase this count without forcing an
        // unrelated global-room census update here; focused settlement tests
        // own the exact Hollowmere capacity/building invariants.
        expect(check.interiorRegionCount).toBeGreaterThanOrEqual(72);
    });
